<template>
  <section class="login-section container">
    <div class="flex justify-center items-center min-h-screen">
      <div class="max-w-md w-full space-y-8 shadow-lg p-7 border rounded-md">
        <div>
          <h2
            class="text-center text-3xl font-extrabold text-gray-900 border-b-2 pb-3"
          >
        ...
        <form class="mt-8 space-y-6" action="#" method="POST">
          ...
          <div>
            <button
              type="submit"
              class="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-cyan-600 hover:bg-cyan-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500 font-bold"
            >
